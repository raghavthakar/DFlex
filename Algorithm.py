...
class CoevolutionaryAlgorithm:
    ...
    def _load_config(self):
        ...
        self.num_cf = self.config_data['Counterfactual']['num_cf']
        self.share_credit = self.config_data['Counterfactual']['share_credit']
        self.random_each_gen  = self.config_data['Counterfactual']['random_each_gen']